...
export const dynamicWeightedMovingAverage = ((data, alpha, noHead?) => {
...
export const smoothedMovingAverage = ((data, size, times = 1) => dynamicWeightedMovingAverage(data, times / size, 1));

// Exponential moving average with 86% total weight

export const exponentialMovingAverage = ((data, size) => dynamicWeightedMovingAverage(data, 2 / (size + 1)));

// simple moving average

export const simpleMovingAverage = ((data, size) => {
  const length = data.length;
...
export const weightedMovingAverage = ((data, size) => {
  const length = data.length;
